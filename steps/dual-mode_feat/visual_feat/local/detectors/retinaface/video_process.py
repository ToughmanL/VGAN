...
class VideoProcess:
    ...
    def __call__(self, video, landmarks, data_filename=None):
        ...
        #     print(data_filename, 'no preprocessed_landmarks')
        #     return
        # if len(preprocessed_landmarks) < self.window_margin:
        #     print(data_filename, 'len(preprocessed_landmarks) < 2')
        #     return
