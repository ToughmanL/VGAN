...
class AVDataset(object):
  def __init__(self, modality, data_partition, data_dir, label_fp, annonation_direc=None,
    ...
    self.fps = 30 if modality == "video" else 16000
...
if __name__ == "__main__":
  ...
  base_dataset = AVDataset(configs, 'train')
  data_loader = torch.utils.data.DataLoader(base_dataset, batch_size=16, num_workers=1)
